...
![导出工作环境 2.png](image/05.png)

导入数据包：

![导入数据包.png](image/06.png)

导入工作环境：

![导入工作环境.png](image/07.png)
...
4. access token将被保存在本地，显示在帮助列表。点击token名称，就可以把它添加到request中。
